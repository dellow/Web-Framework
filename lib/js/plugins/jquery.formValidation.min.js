(function($,window,document,undefined){$.fn.formValidation=function(options){var defaults={username:"#full_name",validationMessage:".validationMessage",requireClass:".required",emailClass:".email",passClass:".pass",passConfirmClass:".pass_confirm",errorClass:"alert error",errorBoxClass:"val-box",otherMessages:".status-messages",statusMessagesClass:"js-status-message",emailRegEx:/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/,passRegEx:/^.*(?=.{8,})(?=.*[0-9])[a-zA-Z0-9]+$/,consecutiveErrors:true,
